...
export {
  ...
  type RuleSource,
  type SitemapDiagnostic,
  type SitemapInput,
  type SitemapExtension,
  type SitemapLoadRequest,
  type SitemapLoadedSource,
  type SitemapLoader,
  type SitemapSetOptions,
  type SitemapSetResult,
  type SitemapSetSummary,
  type SourceLocation,
...
export type {
  LocalSitemapLoaderOptions,
  MemorySitemapLoaderOptions,
} from "./loaders.js";
