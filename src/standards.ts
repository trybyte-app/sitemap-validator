...
export function validateUriOrIri(value: string): UriValidationResult {
  const issues: UriValidationIssue[] = [];
...
export function isValidBcp47LanguageTag(value: string): boolean {
  if (value === "x-default") {
    return true;
  }
...
export function isGoogleSupportedHreflangTag(value: string): boolean {
  if (value === "x-default") {
    return true;
  }
...
export function isIso3166Alpha2RegionCode(value: string): boolean {
  return ISO_3166_ALPHA2_REGION_CODES.has(value.toUpperCase());
}

export function isIso639Alpha2LanguageCode(value: string): boolean {
  return ISO_639_ALPHA2_LANGUAGE_CODES.has(value.toLowerCase());
}

export function isIso639Alpha3LanguageCode(value: string): boolean {
...
export function isIso15924ScriptCode(value: string): boolean {
